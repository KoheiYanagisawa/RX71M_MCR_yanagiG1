...
/*************************************** 自動生成関数 *************************************/
// タイマ割り込み
#define SET_CMT_C0		R_Config_CMT0_Create;		// コンペアマッチタイマ初期化(ch0)
#define START_CMT_C0		R_Config_CMT0_Start;		// カウントスタート(ch0)
#define STOP_CMT_C0	   	R_Config_CMT0_Stop;		// カウント一時停止(ch0)
/******************************************************************************************/
// 機体諸元
